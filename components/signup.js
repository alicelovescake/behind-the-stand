const Signup = () => {
  return (
    <>
      ...
      >
        <label htmlFor="bd-email">Let me drop wisdom bombs in your inbox</label>
        ...
        <div className="mb-2 w-full flex space-x-4">
          ...
          <input type="submit" value="Subscribe" className="duration-150 ease-in transform mr-2 md:px-20 p-4 text-brand-black bg-brand-yellow border-2 border-brand-yellow rounded-lg font-bold"></input>
        </div>
